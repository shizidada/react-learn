        ...
        <Form layout="horizontal">
          <Row className="drawer-avatar-item">
            <div className="drawer-avatar-box">
              ...
              <label htmlFor="upload-avatar-input">
                <input id="upload-avatar-input" className="upload-avatar" type="file" accept="image/png,image/jpeg" />
          ...
          {isEditorAccount ? (
            <Row gutter={16} type="flex" align="middle" className="profile-info-item">
              <Col span={4} className="info-prefix">
                用户名
              </Col>
              <Row className="profile-info-input-item">
                <Col className="input-item">
                  <Input />
                </Col>
            ...
            <Row gutter={16} type="flex" align="middle" className="account-name-item">
              <Col span={4} className="account-name">
                Tom
              </Col>
              <Col span={14} className="editor" onClick={onEditorAccount}>
                <Icon type="edit" />
                修改
              </Col>
            </Row>
          ...
          <Row gutter={16} type="flex" align="middle" className="profile-info-item">
            ...
            {isEditorIntroduce ? (
              <Col className="introduce-item">
                <Input.TextArea value="但行好事，莫问前程。" />
              </Col>
            ) : (
              <Col className="editor" onClick={() => setIsEditorIntroduce(true)}>
                <Icon type="edit" />
                修改
              </Col>
            )}
...
export default Form.create<PersonalSettingDrawerProps>({ name: 'PersonalSettingDrawer' })(PersonalSettingDrawer);
